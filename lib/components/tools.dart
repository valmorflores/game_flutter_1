...
import 'package:teste/components/tools/block_cut.dart';
import 'package:teste/components/tools/block_energy.dart';
import 'package:teste/components/tools/block_normal.dart';
  ...
  ToolsItem({this.gameController, this.name, this.tooltype, this.quantidade}) {
    if (this.tooltype == ToolsType.add_energyblock) {
      itemBlockEnergy = BlockEnergy(
          gameController: this.gameController,
          top: this.gameController.screenSize.height - 60,
          left: 10,
          width: 35,
          height: 35);
