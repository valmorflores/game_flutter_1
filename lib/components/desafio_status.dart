    ...
    if ( this.gameController.state == StateGame.playing ) {
      ...
      if ((painterGangster.text ?? '') != '0000') {
        painterGangster.text = TextSpan(
          text: this.gameController.enemyCount(EnemyType.gangster).toString() + ' / ' + this.gameController.desafios.countbyenemytype(EnemyType.gangster).toString(),
          style: TextStyle(
            color: Colors.white,
            fontSize: 15.0,
          ),
      ...
      if ((painterGerente.text ?? '') != '0000') {
        painterGerente.text = TextSpan(
          text: this.gameController.enemyCount(EnemyType.gerente).toString() + '/' + 
      ...
      if ((painterChefao.text ?? '') != '0000') {
        painterChefao.text = TextSpan(
          text: this.gameController.enemyCount(EnemyType.chefao).toString() + '/' +
