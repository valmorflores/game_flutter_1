...
class LevelHeart {
  ...
  void render(Canvas c) {
    ...
    if (this.imageHeartRed != null) {
      ...
      c.drawImageRect(this.gameController.lives >=1? this.imageHeartRed:this.imageHeartGrey, inputrect, rect, paint);
      left = left + 20 + width;
      // Heart live two
      rect = Rect.fromLTWH( left, 150.0, width, height);
      c.drawImageRect(this.gameController.lives >=2?this.imageHeartRed:this.imageHeartGrey, inputrect, rect, paint);
      left = left + 20 + width;
      // Heart live three
      var rectGrey = Rect.fromLTWH( left, 150.0, width, height);
      c.drawImageRect(this.gameController.lives >=3?this.imageHeartRed:this.imageHeartGrey, inputrect, rectGrey, paint);
      left = left + 20 + width;
    }
  }
}
